...
import type { InvoicesClient as _invoicesrpc_InvoicesClient, InvoicesDefinition as _invoicesrpc_InvoicesDefinition } from './invoicesrpc/Invoices';
...
export interface ProtoGrpcType {
  invoicesrpc: {
    AddHoldInvoiceRequest: MessageTypeDefinition
    ...
    SettleInvoiceMsg: MessageTypeDefinition
    SettleInvoiceResp: MessageTypeDefinition
    SubscribeSingleInvoiceRequest: MessageTypeDefinition
  }
  lnrpc: {
