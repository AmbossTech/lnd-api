...
import type { PeersClient as _peersrpc_PeersClient, PeersDefinition as _peersrpc_PeersDefinition } from './peersrpc/Peers';
...
export interface ProtoGrpcType {
  ...
  peersrpc: {
    FeatureSet: EnumTypeDefinition
    NodeAnnouncementUpdateRequest: MessageTypeDefinition
    NodeAnnouncementUpdateResponse: MessageTypeDefinition
    Peers: SubtypeConstructor<typeof grpc.Client, _peersrpc_PeersClient> & { service: _peersrpc_PeersDefinition }
    UpdateAction: EnumTypeDefinition
    UpdateAddressAction: MessageTypeDefinition
    UpdateFeatureAction: MessageTypeDefinition
  }
}
