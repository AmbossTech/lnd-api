...
import type { SignerClient as _signrpc_SignerClient, SignerDefinition as _signrpc_SignerDefinition } from './signrpc/Signer';
import type { WalletKitClient as _walletrpc_WalletKitClient, WalletKitDefinition as _walletrpc_WalletKitDefinition } from './walletrpc/WalletKit';
...
export interface ProtoGrpcType {
  ...
  signrpc: {
    ...
    MuSig2Version: EnumTypeDefinition
    ...
    Signer: SubtypeConstructor<typeof grpc.Client, _signrpc_SignerClient> & { service: _signrpc_SignerDefinition }
  ...
  walletrpc: {
    ...
    PsbtCoinSelect: MessageTypeDefinition
    ...
    RemoveTransactionResponse: MessageTypeDefinition
